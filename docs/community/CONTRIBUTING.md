...
> **Attribution:** This document originates from the [original UI-TARS-desktop project](https://github.com/bytedance/UI-TARS-desktop) by ByteDance.
> This fork is maintained at [sjkncs/UI-TARS-desktop](https://github.com/sjkncs/UI-TARS-desktop).
> For contributions to the original project, please visit the [upstream repository](https://github.com/bytedance/UI-TARS-desktop).
