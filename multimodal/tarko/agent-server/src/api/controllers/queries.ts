...
export async function executeQuery(req: Request, res: Response) {
  ...
  try {
    ...
    console.error('Unexpected error processing query:', error instanceof Error ? error.constructor.name : 'unknown');
...
export async function executeStreamingQuery(req: Request, res: Response) {
  ...
  try {
    ...
    console.error('Critical error in streaming query:', error instanceof Error ? error.constructor.name : 'unknown');
...
export async function abortQuery(req: Request, res: Response) {
  ...
  try {
    ...
    console.error('Error aborting query:', error instanceof Error ? error.constructor.name : 'unknown');
