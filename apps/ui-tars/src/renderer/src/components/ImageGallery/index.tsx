...
import { MousePointerClick, SkipBack, SkipForward, Download } from 'lucide-react';
...
const ImageGallery: React.FC<ImageGalleryProps> = ({
  ...
  const handleSaveScreenshot = async () => {
    ...
    try {
      await window.electron.ipcRenderer.invoke('system:exportScreenshot', {
        screenshotBase64: currentEntry.imageData,
        fileName: `screenshot_step${currentEntry.originalIndex + 1}.png`,
      });
    } catch {
      // silent fail
    }
